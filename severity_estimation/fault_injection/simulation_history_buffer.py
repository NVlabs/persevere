...
class SimulationHistoryBuffer:
    ...
    def __init__(
        ...
        traffic_light_buffer: Deque[TrafficLightStatusData],
        ...
        self._traffic_light_buffer = traffic_light_buffer
    ...
    @property
    def traffic_light_buffer(self) -> Deque[TrafficLightStatusData]:
        """
        :return: current traffic light buffer
        """
        return self._traffic_light_buffer
    ...
    @property
    def current_traffic_light(self) -> TrafficLightStatusData:
        """
    ...
    @property
    def traffic_lights(self) -> List[TrafficLightStatusData]:
        """
        :return: the traffic light buffer in increasing temporal order where the last sample is the more recent sample
                 [t_-N, ..., t_-1, t_0]
        """
        return list(self._traffic_light_buffer)

    def append(
        self,
        ego_state: EgoState,
        observation: Observation,
        traffic_light_data: TrafficLightStatusData,
    ) -> None:
        """
        ...
        self._traffic_light_buffer.append(traffic_light_data)
    ...
    def initialize_from_list(
        ...
        return cls(
            ...
            observations_buffer=observations_buffer,
            traffic_light_buffer=traffic_light_buffer,
